...
# code is from https://github.com/myscience/variational-diffusion/tree/main
...
class FixedLinearSchedule(nn.Module):
    def __init__(self, gamma_min : float = -13.3, gamma_max : float = 5.0):
        super().__init__()
        self.gamma_min = gamma_min
        self.gamma_max = gamma_max

    def forward(self, t:float) -> Tensor:
        return self.gamma_min + abs(self.gamma_max - self.gamma_min) * t
